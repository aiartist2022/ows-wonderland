    ...
    <SiteShell>
      ...
      <section className="relative overflow-hidden border-b border-white/5 pt-32 pb-20 md:pt-40 md:pb-28">
        ...
        <div className="relative mx-auto w-full max-w-[1920px] px-6 lg:px-10">
          ...
          >
            {brand.logo ? (
              <img src={brand.logo} alt={brand.name} className={`${brand.slug === "ala-corporation" || brand.slug === "ows-automotive" ? "h-12 md:h-20 lg:h-28" : "h-20 md:h-32 lg:h-44"} w-auto object-contain drop-shadow-xl`} />)
            ) : (
