...
export const BRANDS: Brand[] = [
  {
    ...
    description:
      "Founded in the United States three decades ago, OWS Automotive is a leading global provider of end-to-end fleet automotive services. While the company initially offered a broad range of services, today its primary focus is on delivering sustainable solutions to government and corporate fleets.\n\nHeadquartered in the UAE with operations across multiple countries, OWS Automotive combines advanced quality engineering with sustainable remanufacturing processes to set new standards for environmental responsibility and technological innovation.\n\nOWS Automotive has a proven track record with savings to the UAE Government of greater than AED 1 Billion, a significant portfolio of satisfied clients, direct relationships with tier-one automotive suppliers, and serves as an exclusive maintenance supplier to government departments.",
    services: [
  ...
  },
  {
    ...
    description:
      "Established in 2018, AJ Industries is a joint venture between AJ Holding LLC and OWS Automotive, created to pioneer in the automotive and defence segment. The company partners with top-tier international firms to deliver spare parts and MRO services to the GHQ-UAE Armed Forces and government entities.\n\nAJ Holding LLC is a highly regarded organization based in Ajman, UAE, established in 2000, which owns and operates a diverse range of strategically positioned subsidiaries. OWS brings an innovative approach combining sustainable remanufacturing with advanced quality engineering. Together, they have delivered proven savings of more than AED 500 million to the UAE Government.",
    services: [
